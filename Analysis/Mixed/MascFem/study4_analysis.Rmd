...
For female targets, the effect of condition on attraction ratings was fully mediated via perceived femininity. The indirect effect is -0.25 (ACME), which is significant insofar as the confidence interval does not contain zero [-0.41, -0.09]. 
...
For male targets, the effect of condition on attraction ratings was fully mediated via perceived masculinity. The indirect effect is .36 (ACME), which is significant insofar as the confidence interval does not contain zero [0.14, 0.57]. 
